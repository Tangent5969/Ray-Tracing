...
void Uniforms::update(int rayCount, int maxBounces, glm::vec3 camPos, glm::mat4 camModel, float screenW, float screenH, float camFocus, int spheresLength, int accumulationFrame, float environmentLight) {
